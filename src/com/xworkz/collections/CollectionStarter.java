...
public class CollectionStarter {
	...
	public static void main(String[] args) {
				...
				collection2.add("Praktikakkar"");
				collection2.add("Armaan malik");
				collection2.add("Keanu Reeves");
				collection2.add("Neha kakkar ");
				...
				collection2.add("Tanzeel khan");
				collection2.add("Aditi Govitrikar");
				collection2.add("Aditi Sharma");
				collection2.add("Anushkha sharma");
				collection2.add("Aditi Arya");
				collection2.add("Honey singh");
				collection2.add("Abhirami");
				collection2.add("Aashka Goradia");
				collection2.add("Allu arjun");
				collection2.add("Aarti Agarwal");
				collection2.add("Aarathi");
				collection2.add("Aanchal Munjal");
				collection2.add("Mahesh babu");
				collection2.add("Samantha");
				collection2.add("Sonakshi sinha");
				collection2.add("Vicky kaushal");
				collection2.add("Katrina kaif");
				collection2.add("Salman Khan");
				collection2.add("arsh");
				collection2.add("unnati");
				collection2.add("Rakul preet");
				collection2.add("Sanket mehta");
				collection2.add("Aashna Hedge");
				collection2.add("Alia Bhatt");
				collection2.add("Ahad Raza Mir");
				collection2.add("Shruti Hassan");
				collection2.add("Sajaly");
				collection2.add("Hania Aamir");
				collection2.add("Asim Azhar");
				collection2.add("Atif Aslam");
				collection2.add("Rashmi madani");
				collection2.add("Aishwarya Rai Bachchan");
				collection2.add("Sidharth Malhotra");
				collection2.add("Shahid kapoor");
				collection2.add("Mira Kapoor");
				collection2.add("Kaira Advani");
				collection2.add("Kriti sanon");
